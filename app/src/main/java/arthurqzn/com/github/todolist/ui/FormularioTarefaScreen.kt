package arthurqzn.com.github.todolist.ui
...
import arthurqzn.com.github.todolist.util.combinarDataHora
import arthurqzn.com.github.todolist.util.extrairDataDoDatePicker
import arthurqzn.com.github.todolist.util.paraMillisUtcDoDatePicker
import arthurqzn.com.github.todolist.viewmodel.TarefaViewModel
...
fun FormularioTarefaContent(
    ...
    if (mostrarSeletorData){
        ...
        DatePickerDialog(
            ...
            confirmButton = {
                TextButton(onClick = {
                    estadoDatePicker.selectedDateMillis?.let { millisUtc -> val (a, m, d) = extrairDataDoDatePicker(millisUtc)
                        ano = a
                        mes = m
                        dia = d
                    }
